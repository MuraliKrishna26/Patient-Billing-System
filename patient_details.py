...
class patient_details_toshow(Toplevel):
	def __init__(self):
		...
		self.heading = Label(self.top, text="Patient Details",font='arial 15 bold',bg='white',fg='#8a4b27')
		...
		for x_in in x:
			self.listBox.insert(count," Patient ID: "+str(x_in[0])+"||| Patient_name: "+x_in[1]+"||| Contacts : "+str(x_in[2])+"||| Age : "+str(x_in[3]))
